...
const heroTarget = /<!-- Hero Image Illustration -->[\s\S]*?<\/picture>/i;
const heroReplacement = `<!-- Hero Image Illustration -->
            <picture>
              <source
                type="image/webp"
              ...
              <img src="assets/img/hero-graphic-420.webp"
...
const mapTarget = /<!-- Interactive Map Embed -->[\s\S]*?<\/iframe>\s*<\/div>/i;
...
const reviewsTarget = /<!-- Tagembed Google Reviews Widget - ID 328135 -->[\s\S]*?<\/iframe>\s*<\/div>/i;
